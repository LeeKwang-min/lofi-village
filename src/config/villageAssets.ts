...
export const ENVIRONMENT_ASSETS: BuildingConfig[] = [
  ...
  { id: 'custom_env_06', name: '덤불', layer: 'environment', imagePath: './map/Environment/BushBasic.png', cost: 0, description: '자연물' },
  { id: 'custom_env_07', name: '꽃덤불', layer: 'environment', imagePath: './map/Environment/BushFlowerPink.png', cost: 0, description: '자연물' },
  { id: 'custom_env_08', name: '꽃덤불2', layer: 'environment', imagePath: './map/Environment/BushFlowerYellow.png', cost: 0, description: '자연물' },
